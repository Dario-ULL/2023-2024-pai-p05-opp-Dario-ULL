...
describe('Robot', () => {
  describe('Create robot', () => {
    ...
    it('facing east', () => {
      const robot = new Robot()
      robot.place({ direccion: 'east', x: 0, y: 0 })
    ...
    it('facing west, at origin', () => {
      const robot = new Robot()
      robot.place({ direccion: 'west', x: 0, y: 0 })
    ...
    it('at negative position facing south', () => {
      const robot = new Robot()
      robot.place({ direccion: 'south', x: -1, y: -1 })
    ...
    it('invalid robot bearing', () => {
      ...
      expect(() => robot.place({ direccion: 'crood', x: 0, y: 0 })).toThrow(
        InvalidInputError
      )
    })
  })
  ...
  describe('Rotating clockwise', () => {
    ...
    it('changes north to east', () => {
      robot.place({ direccion: 'north', x: 0, y: 0 })
    ...
    it('changes south to west', () => {
      robot.place({ direccion: 'south', x: 0, y: 0 })
  ...
  describe('Follow series of instructions', () => {
    ...
    it('moving east and north from README', () => {
      robot.place({ x: 7, y: 3, direccion: 'north' })
    ...
    it('moving west and north', () => {
      robot.place({ x: 0, y: 0, direccion: 'north' })
    ...
    it('moving west and south', () => {
      robot.place({ x: 2, y: -7, direccion: 'east' })
    ...
    it('moving east and north', () => {
      robot.place({ x: 8, y: 4, direccion: 'south' })
    ...
    it('instruct many robots', () => {
      ...
      robot1.place({ x: 0, y: 0, direccion: 'north' })
      robot2.place({ x: 2, y: -7, direccion: 'east' })
      robot3.place({ x: 8, y: 4, direccion: 'south' })
